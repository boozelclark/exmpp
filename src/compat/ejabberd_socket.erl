...
starttls(SocketData, TLSOpts) ->
    {ok, TLSSocket} = e_tls:tcp_to_tls(SocketData#socket_state.socket, TLSOpts),
...
get_peer_certificate(SocketData) ->
    e_tls:get_peer_certificate(SocketData#socket_state.socket).

get_verify_result(SocketData) ->
    e_tls:get_verify_result(SocketData#socket_state.socket).
